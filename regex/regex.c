...
#ifdef MATCH_MAY_ALLOCATE
/* milbo: this is the one we execute */
# define FREE_VAR(var) if (var) REGEX_FREE (var); var = NULL

    #if _MSC_VER /* microsoft */
        /* milbo: added void * typecase for microsoft compiler */
