...
#define RELEASED 0	// changed to 0 by milbo

/* Define if you have inline */
/* #undef HAVE_INLINE */
#define HAVE_INLINE 1	// changed by milbo for fast code under MSC

/* Define if you need to hide the static definitions of inline functions */
/* #undef HIDE_INLINE_STATIC */
#define HIDE_INLINE_STATIC 1	// changed by milbo for clean link under MSC
